...
public class Constants {
    ...
    public static final String LBL_PASSWORD_CHANGE_UNAVAILABLE = "security.password.change.unavailable";

    public static final String LBL_PASSWORD_CHANGE_PAGE_TITLE = "security.password.change.dialog.panel.title";
