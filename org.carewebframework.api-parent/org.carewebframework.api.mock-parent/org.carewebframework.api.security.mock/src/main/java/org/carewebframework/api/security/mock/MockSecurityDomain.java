...
public class MockSecurityDomain implements ISecurityDomain {
    ...
    public IUser authenticate(String username, String password) {
        if (!check("org.carewebframework.security.mock.username", username)
                || !check("org.carewebframework.security.mock.password", password)) {
            throw new RuntimeException("Authentication failed.");
        }
        
        return new MockUser(SpringUtil.getProperty("org.carewebframework.security.mock.userid"),
                SpringUtil.getProperty("org.carewebframework.security.mock.fullname"), username, password, this);
    }
