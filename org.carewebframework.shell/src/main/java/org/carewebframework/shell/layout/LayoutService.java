...
public class LayoutService implements ILayoutService {
    ...
    private static final String PROPERTY_LAYOUT_SHARED = "CAREWEB.LAYOUT.SHARED";

    private static final String PROPERTY_LAYOUT_PRIVATE = "CAREWEB.LAYOUT.PRIVATE";

    private static final String PROPERTY_LAYOUT_ASSOCIATION = "CAREWEB.LAYOUT.ASSOCIATION";
