...
public class CareWebUtil {
    ...
    private static final String ACTION_BASE = "sscript-groovy:" + CareWebUtil.class.getName() + ".getShell().";
    ...
    public static CareWebShell getShell() {
        return (CareWebShell) ExecutionContext.getPage().getAttribute(Constants.SHELL_INSTANCE);
    }
