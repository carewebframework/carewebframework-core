...
public class GlobalEventDispatcher extends AbstractGlobalEventDispatcher implements MessageListener {
    ...
    private JmsTemplate jmsTopicTemplate; //default "not transacted" and "auto-acknowledge"
    ...
    private void doHostSubscribe(final String eventName) throws JMSException {
        ...
        final String topicName = EventUtil.getTopicName(eventName);
        final String selector = EventUtil.getMessageSelector(eventName, getClientId());
    ...
    private void doFireRemoteEvent(final String eventName, final Object eventData, final String recipients)
        ...
        this.jmsTopicTemplate.send(EventUtil.getTopicName(eventName), new MessageCreator() {
            ...
            public Message createMessage(final Session session) throws JMSException {
                return EventUtil.createObjectMessage(session, eventName, (Serializable) eventData, recipients);
            }
        });
    }
    ...
    /**
     * @param jmsTopicTemplate the jmsTemplate to set with pub sub config
     */
    ...
    /**
     * Returns the client id for the JMS connection.
     * 
     * @return The JMS client id.
     */
    @Override
