...
public class DialogControl<T> {
     ...
     */
    public static DialogControl<String> toDialogParameters(String message, String title, String styles, String responses,
                                                           String excludeResponses, String defaultResponse,
                                                           String saveResponseId, IPromptCallback<String> callback) {
        return new DialogControl<String>(message, title, styles, responses.split("\\|"),
                excludeResponses == null ? null : excludeResponses.split("\\|"), defaultResponse, saveResponseId, callback);
    }
    ...
    public DialogControl(String message, String title, String styles, T[] responses, T[] excludeResponses, T defaultResponse,
        ...
        this.responses = DialogResponse.toResponseList(responses, excludeResponses, defaultResponse);
