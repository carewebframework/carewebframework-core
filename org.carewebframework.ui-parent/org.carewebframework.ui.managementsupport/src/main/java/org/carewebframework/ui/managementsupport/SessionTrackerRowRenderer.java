 ...
 */
public class SessionTrackerRowRenderer extends AbstractRowRenderer<SessionInfo, Object> {
    ...
    private static final Log log = LogFactory.getLog(SessionTrackerRowRenderer.class);
